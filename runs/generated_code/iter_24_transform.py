...
def main():
    ...
    try:
        ...
        # Apply CondensedNearestNeighbour for undersampling
        cnn = CondensedNearestNeighbour(random_state=42)
        X_resampled, y_resampled = cnn.fit_resample(X_imputed, y)

        # Ensure no NaN values in the resampled features
        if X_resampled.isnull().values.any():
            raise ValueError("NaN values found in resampled features")
